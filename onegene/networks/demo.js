...
$(function(){
  ...
  var graphP = $.ajax({
    url: './6915_Ec.interactions.sif.json',
    type: 'GET',
    dataType: 'json'
  });
  ...
  var infoTemplate = Handlebars.compile([
    ...
    '<p class="ac-more"><i class="fa fa-external-link"></i><a target="_blank" href="https://ecocyc.org/ECOLI/search-query?type=GENE&gname={{name}}">More information @ Ecocys</a></p>',
    '<p class="ac-more"><i class="fa fa-external-link"></i><a target="_blank" href="http://colombos.net">More information @ Colombos.net</a></p>',
    '<p class="ac-more"><i class="fa fa-external-link"></i><a target="_blank" href="https://www.ncbi.nlm.nih.gov/gene/?term={{name}}">More information @ NCBI</a></p>',
    '<p class="ac-more"><i class="fa fa-cloud-download" aria-hidden="true"></i><a href="" download="filename">Download Gene Data</a></p>'
  ].join(''));
